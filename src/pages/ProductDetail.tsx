  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-8 py-12 w-full bg-background text-foreground">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
        {/* Product Image Panel */}
        <div className="lg:col-span-7 rounded-xl overflow-hidden bg-white dark:bg-white border border-border relative aspect-square w-full items-center justify-center flex">
