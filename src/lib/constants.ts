...
export const getCategoryImage = (category?: string, customMapping?: Record<string, string>, allowDefault: boolean = true) => {
  ...
  const DEFAULT_CATEGORY_IMAGES: Record<string, string> = {
    ...
    'indian vegetables': 'https://images.unsplash.com/photo-1629853908077-d0d61994bd5a?w=600&auto=format&fit=crop&q=80',
    'indian vegetable': 'https://images.unsplash.com/photo-1629853908077-d0d61994bd5a?w=600&auto=format&fit=crop&q=80',
